...
from cat_counter_detection.services.error_handler import ErrorHandler, ErrorSeverity


# Define ComponentStatus locally to avoid import issues
...
class HealthChecker:
        ...
        try:
            ...
            if self.error_handler:
                try:
                    ...
                    # Error handler might not have this method or return expected format
                    pass
            ...
            if (check.last_check is None or 
                ...
                try:
                    ...
                    if result:
                        ...
                        self.component_status[check.name] = ComponentStatus.HEALTHY
                    else:
    ...
    def _handle_component_failure(self, check: ComponentHealthCheck) -> None:
        ...
        self.component_status[check.name] = ComponentStatus.FAILED
    ...
    def get_diagnostic_info(self) -> Dict[str, Any]:
        ...
        if self.error_handler:
            try:
                ...
                diagnostic_info["degradation_info"] = degradation_info
            except AttributeError:
                # Error handler might not have these methods
                pass
    ...
    def _get_degradation_status(self) -> Dict[str, Any]:
        ...
        if self.error_handler:
            try:
                ...
                # Error handler might not have this method
                pass
